...
function validateForm() {
    ...
    var groups = document.Form.groups.value;
    var zipcode = document.Form.zipcode.value;



    var nameErr = emailErr = mobileErr = eventsErr = genderErr = passwordErr = groupsErr = zipcodeErr = true;
    ...
    if (groups == "Select") {
        printError("groupsErr", "Please select Groups");
        var elem = document.getElementById("groups");
        elem.classList.add("input-4");
        elem.classList.remove("input-3");
    } else {
        printError("groupsErr", "");
        groupsErr = false;
        var elem = document.getElementById("groups");
